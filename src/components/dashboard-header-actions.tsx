  ...
  return (
    <div className="header-account-actions" ref={rootRef}>
      ...
      <details className="profile-menu" open={openMenu === "profile"}>
        ...
        >
          {avatar}
          <span><strong>{displayName}</strong><small>@{publicUsername}</small></span>
        </summary>
        ...
        <div className="profile-menu-popover">
          <div className="profile-menu-user">
            ...
            <div><strong>{displayName}</strong><small>@{publicUsername}</small></div>
          </div>
      ...
      <details className="mobile-navigation" open={openMenu === "navigation"}>
        ...
        <div className="mobile-navigation-panel">
          ...
          <nav aria-label="Mobile dashboard navigation">
            {primaryLinks.map(([label, href]) => <Link href={href} key={href} onClick={closeMenus}>{label}<span aria-hidden="true">›</span></Link>)}
          </nav>
        </div>
      </details>
    </div>
