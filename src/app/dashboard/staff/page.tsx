  ...
  return (
    <div className="section-stack">
      <section className="page-heading">
        <div>
          <div className="staff-heading-meta"><span className="eyebrow">Private platform operations</span><span className="badge">{access.displayLabel ?? access.role}</span></div>
