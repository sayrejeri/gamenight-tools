...
type TeamRow = RowDataPacket & { id: string; slug: string; name: string; tag: string | null; description: string | null; logo_url: string | null; banner_url: string | null; main_platform: string | null; main_game: string | null; region: string | null; recruiting_status: string; verification_level: string | null; member_role: string | null; member_count: number };
